// Shared code-block highlighting for public essays and the admin preview.
...
(function(global) {
  ...
  function attachCodeLanguageButton(code, label) {
    ...
    button.addEventListener('click', function() {
      var done = function() {
        ...
        global.setTimeout(function() { button.dataset.action = 'COPY'; }, 1200);
      };
  ...
  global.highlightCodeBlocks = highlightCodeBlocks;
})(window);
